...
if __name__ == "__main__":
    ...
    if load_model:
        ...
        history = model.train_pinn(
            ...
            source_amplitude=source_amplitude,    # Default amplitude (not used for zero source)
    ...
    if TRAINING_CASE == 'with_source':
        ...
        if gt_rollout is not None:
            ...
            rollout_plot_filename = os.path.join(SCRIPT_DIR, f'logs_multibranch_wave/pinn_wave_rollout_{TRAINING_CASE}.png')
