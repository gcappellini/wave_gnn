...
specifyCoefficients(model,m=0,d=[1; 0; 0; 1],c=[0; 0; 0; 0; -wave_speed^2; 0; 0; -wave_speed^2; 0; 0; 0; 0; 0; 0; 0; 0],a=[0; 0; -1; k],f=[0; 0]);
...
applyBoundaryCondition(model,"dirichlet","Edge",[1,2,3,4],"u",[0,0]);
...
% specifyCoefficients(model,m=0,d=[d*results.M; 0; 0; d*results.M],c=[0; 0; 0; 0; -wave_speed^2; 0; 0; -wave_speed^2; 0; 0; 0; 0; 0; 0; 0; 0],a=[0; 0; -1; k],f=[0; 0]);
figure
pdemesh(model);
ylim([-0.1 1.1]);
axis equal
...
for i = 1:length(tlist)
    ...
    for j = 1:n_nodes
        ...
        u_val = result.NodalSolution(j, 1, i);
        v_val = result.NodalSolution(j, 2, i);
...
u = result.NodalSolution(:,1,:);  % size = [1537, 100]
